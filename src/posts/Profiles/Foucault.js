            ...
            <div>
                <div className="section first-section colored-background" style={{display: 'flex'}}>
                    ...
                    <div className="contact">
                        <h1>Céline Foucault :</h1>
                        <div className="sub-title">Psychologue - psychanalyste</div>
                        <div><FontAwesomeIcon icon={faPhone}/>: 06 XX XX XX XX</div>
                        <div><FontAwesomeIcon icon={faEnvelope}/>: foucault@xxx.com</div>
                    </div>
                </div>
                <div className="section">
                    ...
                    <p>
                        Je travaille en cabinet libéral depuis une quinzaine d’années. Dans ce cadre je m’adresse à un
                ...
                <div className="section colored-background">
                    <h2>
                        <PageH2Before/>
                        <span className="bold">Mes diplômes :</span>
                    </h2>
                    <ul>
                ...
                <div className="section">
                    <h2>
                        <PageH2Before/>
                        <span className="bold">Mon parcours professionnel :</span>
                    </h2>
                    <p>
